...
_Generated: 2026-05-02T14:54:40.315Z_
...
Workspace `mcp.json` _(folder: Mali-final-web)_

- **c:\Users\Jjo_2\Desktop\Mali-final-web\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Jjo_2\AppData\Roaming\Code\User\mcp.json** — _File missing_
